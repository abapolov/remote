...
// Returns the private 'App\Repository\SourceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SourceRepository.php';

return $this->privates['App\Repository\SourceRepository'] = new \App\Repository\SourceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
